...
const playlistsIds = {
  LatestSongs: 'PL-oM5qTjmK2vxdTsj2Xghu5fjxhtuMaxo',
  RomanticSongs: 'PL6_AX-gRSOpvDCrSR3EaPdEgUbtmA6bkO',
...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <SongCard songs={songObj.latestSongs} categotyTitle={'Super Hit Punjabi'} />

      <SongCard songs={songObj.romanticSongs} categotyTitle={'Latest Punjabi'} />
